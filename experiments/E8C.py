...
You will be given specific pieces of information regarding a used instruction that my friend used
when prompting a model to perform a task. Your job now is it to understand how the model misbehaved
and why its performance is suboptimal.

Analyse the evaluation information present and give a verdect. Afterwards provide a new prompt based
on how you think the previous instruction failed. Provide the new instruction in <INSTR> tags like 
this <INSTR>...</INSTR>.

This is now the information you get:
